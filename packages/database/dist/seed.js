...
var require_client = __commonJS({
  "generated/client/index.js"(exports2) {
    ...
    exports2.Prisma.JobScalarFieldEnum = {
      id: "id",
      title: "title",
      company: "company",
      location: "location",
    ...
    exports2.Prisma.ApplicationScalarFieldEnum = {
      id: "id",
      status: "status",
...
`,
      "inlineSchemaHash": "afcb5fa31190bf85ec3f3dd4269c69dd77f5e620f2b51a24b8df56ddf8d7f84e",
      "copyEngine": true
    };
    var fs2 = require("fs");
...
async function main() {
  ...
  const recruiterId = (recruiter == null ? void 0 : recruiter.id) || (await prisma.user.create({
    data: {
      id: (0, import_uuid.v4)(),
      name: "Demo Recruiter",
  ...
  const jobs = [
    {
      ...
      isRemote: true,
      applicationDeadline: new Date(Date.now() + 21 * 24 * 60 * 60 * 1e3),
      // 21 days from now
      isActive: true,
      industry: "Technology",
      jobType: "Full-time",
    ...
    },
    {
      ...
      isRemote: false,
      applicationDeadline: new Date(Date.now() + 30 * 24 * 60 * 60 * 1e3),
      // 30 days from now
      isActive: true,
      industry: "Software",
      jobType: "Full-time",
      ...
      recruiterId,
      expiresAt: new Date(Date.now() + 45 * 24 * 60 * 60 * 1e3),
      // 45 days from now
      applicants: JSON.stringify({
        total: 0,
        qualified: 0
    ...
    },
    {
      ...
      isRemote: true,
      applicationDeadline: new Date(Date.now() + 45 * 24 * 60 * 60 * 1e3),
      // 45 days from now
      isActive: true,
    ...
    },
    {
      ...
      isRemote: true,
      applicationDeadline: new Date(Date.now() + 15 * 24 * 60 * 60 * 1e3),
      // 15 days from now
      isActive: true,
    ...
    },
    {
      ...
      isRemote: false,
      applicationDeadline: new Date(Date.now() + 25 * 24 * 60 * 60 * 1e3),
      // 25 days from now
      isActive: true,
      industry: "Software",
      jobType: "Full-time",
      experienceLevel: "Mid-level",
      recruiterId,
      expiresAt: new Date(Date.now() + 40 * 24 * 60 * 60 * 1e3),
      applicants: JSON.stringify({
        total: 0,
        qualified: 0
      }),
